...
import { SamplesListingItemComponent } from '../samples-listing-item/samples-listing-item.component';
...
@Component({
  ...
  styleUrls: ['./admin-samples.component.scss'],
  imports: [
    TranslateModule,
    SpinnerComponent,
    MatFormFieldModule,
