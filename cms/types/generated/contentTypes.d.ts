...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    salaryPerYear: Schema.Attribute.String;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiMaterialLandingPageMaterialLandingPage
  extends Struct.CollectionTypeSchema {
  collectionName: 'material-landing-pages';
  info: {
    displayName: 'Material Landing Page';
    pluralName: 'material-landing-pages';
    singularName: 'material-landing-page';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::material-landing-page.material-landing-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    resourceCategory: Schema.Attribute.Enumeration<
      [
        'WasteTrade Guides',
        'Plastics',
        'Paper',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::material-landing-page.material-landing-page': ApiMaterialLandingPageMaterialLandingPage;
