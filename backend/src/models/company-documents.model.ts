...
@model({
    settings: { idInjection: false, postgresql: { schema: 'public', table: 'company_documents' } },
})
export class CompanyDocuments extends Entity {
    @property({
        type: 'number',
    ...
    constructor(data?: Partial<CompanyDocuments>) {
        super(data);
    }
}

export interface CompanyDocumentsRelations {
    // describe navigational properties here
}

export type CompanyDocumentsWithRelations = CompanyDocuments & CompanyDocumentsRelations;
